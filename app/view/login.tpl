        ...
        <span id="info">
           ...
           ?>
            ...
            <div style="float:right; font-size: 80%; position: relative; top:-10px">
                <form id="loginform" method="POST" action="<?= BASE_URL ?>/forgotpassword" class="form-horizontal" role="form">
                    <button type="submit" class='btn btn-sm'>Forgot password?</button>
                </form>
            </div>
